...
values
  ...
  ('Nitrogen Deficiency',
   'V-shaped pale green to yellowing starting at the leaf tip of older leaves and progressing down the midrib toward the base.',
   'Urea (46-0-0)',
  ...
  ('Phosphorus Deficiency',
   'Stunted appearance with dark green, purpling, or reddish-purple discoloration starting on the tips/undersides of young leaves and spreading outward.',
   'Solophos (0-18-0)',
   '2 bags per hectare',
   'Band near the root zone at planting or early vegetative',
   'Check soil pH; uptake drops sharply in strongly acidic soil.'),
  ('Potassium Deficiency',
   'Yellowing and scorching ("firing") along the margins of older leaves, progressing inward while leaving the center green.',
